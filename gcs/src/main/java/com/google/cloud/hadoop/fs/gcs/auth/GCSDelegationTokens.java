...
public class GCSDelegationTokens {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(GCSDelegationTokens.class);
  ...
  public void init(final Configuration conf) {
    ...
    try {
      ...
      LOG.error("Failed to load configured delegation token binding {}",
                tokenBindingImpl,
                e);
    }
  }
  ...
  public Token<AbstractGCPTokenIdentifier> getBoundOrNewDT()
      throws IOException {
    ...
    if (isBoundToDT()) {
      ...
      Token<AbstractGCPTokenIdentifier> token =
                            tokenBinding.createDelegationToken(null);
      return token;
    }
  }
